...
import cachetools
import sys
sys.path.append('/Users/prithviseran/Documents/Forex_Trading_bot')

from auth import _helpers
from auth import _service_account_info
...
class Credentials(
    auth.credentials.Signing, auth.credentials.CredentialsWithQuotaProject
):
    ...
    @_helpers.copy_docstring(auth.credentials.CredentialsWithQuotaProject)
    ...
    @_helpers.copy_docstring(auth.credentials.Signing)
